...
public class MonteCarloSearchPlayer extends StateMachineGamer {
	...
	private double depthCharge(Role role, MachineState state, long timeout) throws GoalDefinitionException {
		try {
			StateMachine stateMachine = getStateMachine();
	...
	public String getName() {
		return "Monte Carlo Search Player";
	}
